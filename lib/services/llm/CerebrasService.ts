...
export class CerebrasService {
  ...
  private buildCategorizationSystemPrompt(): string {
    return [
      ...
      '3. allowancesBenefits: Optional allowances like meal vouchers, transportation, remote work stipends, health benefits, VAT on local office payments, local office monthly payments',
      '4. terminationCosts: Severance and notice provisions (monthlyized termination liabilities only)',
      '5. oneTimeFees: One-time setup costs, background checks, medical exams, onboarding fees (NOT VAT or recurring monthly fees)',
      '',
      ...
      '- VAT on Local Office Payments, Local Office Monthly Payments, any items with "local office" in name = allowancesBenefits (recurring monthly costs)',

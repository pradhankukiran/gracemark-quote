...
${quoteType === 'statutory-only'
  ...
  : includeCommonBenefits
    ...
    return [
      ...
      '• Termination Provisions: Check termination section (severance + notice obligations)',
      '',
      includeCommonBenefits ? [
      ...
      '• Severance Cost: BASE_SALARY ÷ 12',
      '• Notice Period Cost: BASE_SALARY ÷ CONTRACT_MONTHS',
